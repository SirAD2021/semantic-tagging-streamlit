...
# def get_tfidf_tags(chunks, top_n=10):
...
#     # Calculate average tf-idf across all chunks
...
#     # Extract top N tags (e.g., 10-20)
#     top_tags = [term for term, score in term_scores[:20]]

#     return top_tags

# def get_ngram_tfidf_tags(chunks, top_n=20):
#     vectorizer = TfidfVectorizer(ngram_range=(2, 3), stop_words='english', min_df=2)  # bigrams and trigrams
#     tfidf_matrix = vectorizer.fit_transform(chunks)
